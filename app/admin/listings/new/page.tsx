...
const defaultListing: Partial<Listing> = {
  ...
  status: 'available',
  images: [],
  paymentPlan: { depositKES: 0, months: 12 },
  features: [],
  shortDescription: '',
  longDescription: '',
  amenities: [],
...
export default function NewListingPage() {
  ...
  return (
    <div className="min-w-0">
      ...
      <h1 className="text-xl sm:text-2xl font-semibold text-neutral-900 mb-4 sm:mb-6">Add new listing</h1>
      <ListingForm
        listing={listing}
...
function ListingForm({
  ...
  setListing: (l: Partial<Listing> | ((p: Partial<Listing>) => Partial<Listing>)) => void
  update: (key: keyof Listing, value: unknown) => void
  featuresText: string
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) => update('coords', { ...listing.coords, lat: parseFloat(e.target.value) || 0 })}
            />
          </div>
          <div>
            ...
            <Input
              ...
              onChange={(e) => update('coords', { ...listing.coords, lng: parseFloat(e.target.value) || 0 })}
            />
          </div>
        </div>
        <div>
